...
public class QRCodeFactory {
     ...
     */
      ...
      */
    public  void CreatQrImage(String content,String format,String outFileUri,String logUri, int ...size) throws Exception{
    	BitMatrix bitMatrix = createQr(content, format, logUri, size);
        // 生成二维码图片文件
     ...
     * @param content            二维码内容
     * @param format             生成二维码的格式
     * @param stream         	  二维码的输出流
     * @param logUri             二维码中间logo的地址
     * @param size               用于设定图片大小（可变参数，宽，高）
     * @throws IOException       抛出io异常
     * @throws WriterException   抛出书写异常
     */
	public  void CreatQrStream(String content,String format,OutputStream stream,String logUri, int ...size) throws Exception{
		BitMatrix bitMatrix = createQr(content, format, logUri, size);
	    MatrixToImageWriter.writeToStream(bitMatrix, format, stream,logUri);
	}
   
    private BitMatrix createQr(String content,String format,String logUri, int ...size) throws Exception {
